...
- http://g211r34445.iok.la/htdocs/HPD-Kit  or  https://pan.baidu.com/s/1nH5Uv_BoeBpGalr7bllt0A?pwd=68cd
- decompression the Singularity image and database files:
  ```bash
  gunzip HPD-Kit-v2.0.img.gz
  unzip virus.zip
  ```
