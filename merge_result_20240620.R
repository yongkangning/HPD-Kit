...
# add fiter
output_all <- merge_res_distinct %>% mutate(filter = if_else(blast_reads_count >= min_unique_reads &
...
write_tsv(output_all, output_file_all)
write_tsv(output_filtered, output_file_filtered)
